...
namespace FinalSis457Cbcd.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(FinalSis457CbcdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Usuarios != null ? 
                          ...
                          Problem("Entity set 'FinalSis457CbcdContext.Usuarios'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FinalSis457CbcdContext.Usuarios'  is null.");
            }
            var usuario = await _context.Usuarios.FindAsync(id);
            if (usuario != null)
            {
